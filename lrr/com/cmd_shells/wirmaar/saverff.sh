...
OPKGBUILD=$ROOTACT/lrr/com/cmd_shells/wirmaar/act-opkg-build.sh
...
VERSION="$(cat $ROOTACT/lrr/Version)"
cat $LRRDIR/opkg/CONTROL_wirmaar/control | sed "s/_REPLACE_VERSION_/$VERSION/" > $TMPDIR/CONTROL/control
cp $LRRDIR/opkg/CONTROL_wirmaar/postinst $TMPDIR/CONTROL/postinst
