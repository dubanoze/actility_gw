...
cat $DEST_DIRECTORY/lrr/opkg/CONTROL_wirmams/control | sed "s/_REPLACE_VERSION_/$VERSION/" > ${OPKG_DIR}/CONTROL/control

cp $DEST_DIRECTORY/lrr/opkg/CONTROL_wirmams/postinst ${OPKG_DIR}/CONTROL/postinst
