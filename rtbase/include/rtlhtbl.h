...
#define	HTBL_GET_REMOVE		1 // remove flag for htblGetDup() htblGetCopy()


#define	HTBL_WRONG_THREAD	-100
...
int rtl_htblSetUpdateFunc(void *htbl, void (*updatefunc)(void *h,char *k,void *olddata,void *newdata));
...
int rtl_htblUpdateAdd(void *htbl, void *data); // only if HTBL_KEY_INCLUDED
